...
<head>
    ...
    <title><sitemesh:title default="Luffy"/> - 一件运营管理后台</title>
    ...
    <link href="${ctx}/static/css/plugins/dtgrid/dlshouwen.grid.css" rel="stylesheet">
    ...
    <!-- dlshouwen grid -->
    <script src="${ctx}/static/js/plugins/dtgrid/dlshouwen.grid.js"></script>
    <script src="${ctx}/static/js/plugins/dtgrid/i18n/zh-cn.js"></script>
    ...
    <script src="${ctx}/static/js/plugins/multiselect/bootstrap-multiselect.js" type="text/javascript"></script>

    <%--<link href="${ctx}/static/js/plugins/bootstrap-datetimepicker/css/bootstrap-datetimepicker.min.css" rel="stylesheet">--%>
    <%--<script src="${ctx}/static/js/plugins/bootstrap-datetimepicker/js/bootstrap-datetimepicker.min.js"></script>--%>
    <%--<script src="${ctx}/static/js/plugins/moment/min/moment.min.js"></script>--%>
