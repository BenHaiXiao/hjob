package com.github.bh.hjob.core.dtgrid;
...
public class Pager {
	...
	public static Long convertParmToLong(Pager pager, String param,Long defaultValue){
		Long value = convertParmToLong(pager,param);
	...
	public static Long convertParmToLong(Pager pager, String param){
		String value = convertParmToStr(pager,param);
	...
	public static Integer convertParmToInteger(Pager pager, String param,Integer defaultValue){
		Integer value = convertParmToInteger(pager,param);
		if ( defaultValue != null && value == null ){
			return defaultValue;
		}else {
			return value;
	...
	public static Integer convertParmToInteger(Pager pager, String param){
		String value = convertParmToStr(pager,param);
		if (StringUtils.isBlank(value)){
			return null;
		}else {
	...
	public static String convertParmToStr(Pager pager, String param,String defaultValue){
		String value = convertParmToStr(pager,param);
		if ( StringUtils.isNoneBlank(defaultValue) && StringUtils.isBlank(value) ){
			return defaultValue;
		}else {
			return value;
		}
	...
	public static String convertParmToStr(Pager pager, String param){
		if (pager == null || param == null || pager.getParameters( ) == null){
			return null;
		}
		String value = String.valueOf(pager.getParameters().get(param));
	...
	public static Byte convertParmToByte(Pager pager, String param,Byte defaultValue){
		Byte value = convertParmToByte(pager,param);
		if ( defaultValue != null && value == null ){
			return defaultValue;
		}else {
			return value;
	...
	public static Byte convertParmToByte(Pager pager, String param){
